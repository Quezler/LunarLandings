...
-- local rocket_silos_to_simulate = {
--   ["rocket-silo"] = true,
--   ["ll-rocket-silo-down"] = true,
...
local function launch_if_destination_has_space(silo_data, empty_slots_required)
  ...
  if destination_name == "Space" or destination_name == "Nauvis Surface" or destination_name == "Luna Surface" then
    ...
    local destination = ll_util.get_destination_landing_pad(destination_name, ll_util.get_other_surface_name(silo.surface.name))
...
local function on_rocket_launched(event)
  if event.rocket_silo.name == "ll-rocket-silo-interstellar" then
    local rocket = event.rocket
